<template>
  <PlaygroundShell :background-color="selectedTheme.background">
    <PlaygroundWindow :background-color="selectedTheme.background" variant="adaptive">
      <template #nav>
        <PlaygroundNav active="dual" :items="playgroundNavItems" />
      </template>
      <template #controls>
      ...
      <DualTerminalGrid>
        <template #left>
          <DualTerminalPane
            ...
            :frame-enabled="frameEnabled"
            storage-key="embedos-playground-dual-workspace"
        ...
        <template #right>
          <DualTerminalPane
            ...
            :frame-enabled="frameEnabled"
            storage-key="embedos-playground-dual-clean-room"
            :terminal="terminalOptions"
          />
        </template>
      </DualTerminalGrid>
...
import DualTerminalGrid from "./components/DualTerminalGrid.vue";
import DualTerminalPane from "./components/DualTerminalPane.vue";
...
const cleanRoomConfig = createObserverPlaygroundRecipe(debianBullseyeBusyboxRuntime);
